...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'LinkedIn', icon: 'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z', href: 'https://www.linkedin.com/in/soumeya-mouaki-benani-benani-7315b2398' },
